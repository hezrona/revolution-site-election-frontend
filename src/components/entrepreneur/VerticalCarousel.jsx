    ...
    >
      <div className="container">
        <header className="vc-header">
          <span className="vc-eyebrow">Entrepreneuriat</span>
          <h2>Soutenir les entrepreneurs français à Madagascar : une ambition concrète</h2>
          <p>
            Chaque écran reprend la structure fournie : bloc visuel à gauche,
            texte à droite, message de synthèse en bas. Le défilement est
            automatique et peut être contrôlé manuellement.
          </p>
        </header>
